/*! For license information please see main.32cb0974.js.LICENSE.txt */
(() => {
  var e = {
      238: (e, t) => {
        'use strict';
      ...
      730: (e, t, n) => {
        ...
        function Ja(e, t) {
          switch ((Oo(Qa, t), Oo(Ka, e), Oo(qa, $a), (e = t.nodeType))) {
            case 9:
            case 11:
        ...
        function xi(e, t) {
          ...
          if (
            ...
            if (
              ((n.flags |= 2048),
              Ti(9, Ei.bind(null, n, r, o, t), void 0, null),
              null === Ps)
            )
              throw Error(a(349));
            0 !== (30 & ii) || ji(n, t, o);
        ...
        function uc(e) {
          ...
          try {
            ...
            (yt = r), (Os.transition = n), 0 === (6 & (Cs = t)) && Wo();
          }
        }
        function dc() {
          (Ls = Ms.current), Eo(Ms);
        ...
        function gc(e, t) {
          ...
          if ((Oa(), (Cs = n), (js.current = r), null !== Ns))
            throw Error(a(261));
        ...
        function Sc() {
          if (null !== Qs) {
            var e = kt(Ys),
              ...
              n = yt;
            try {
              if (((Os.transition = null), (yt = 16 > e ? 16 : e), null === Qs))
                var r = !1;
              else {
                  ...
                  (function (e, t, n) {
                    switch (t.tag) {
                      ...
                      case 10:
                        ...
                        Oo(_a, r._currentValue), (r._currentValue = o);
                        break;
                      case 13:
            ...
            (t.slideHandler = function (e) {
              ...
              if (r) {
                ...
                (v = w),
                  ...
                  !o && w + h >= i && (v = i - h),
                  (b = O(s(s({}, e), {}, { slideIndex: w }))),
                  (y = O(s(s({}, e), {}, { slideIndex: v }))),
                  o || (b === y && (w = v), (b = y)),
    ...
    (() => {
      ...
      function Ce() {
        for (var e = arguments.length, t = new Array(e), n = 0; n < e; n++)
          t[n] = arguments[n];
        ('string' === typeof t[0] && Oe[t[0]]) ||
          ('string' === typeof t[0] && (Oe[t[0]] = new Date()),
          (function () {
      ...
      const Be = './static/media/moon.5694b77030f6704e9146a3b16f64cf3b.svg';
      const $e = './static/media/sun.50e2030b26995fbe1b76baf18215a03f.svg',
        qe = { logo: 'Logo_logo__h7Oe-', logo_num: 'Logo_logo_num__XzCCY' };
      var Ke = n(579);
      function Qe() {
      ...
      const Ye = {
        lang: 'Lang_lang__e4ULP',
        lang_select: 'Lang_lang_select__A06Bc',
        langDark: 'Lang_langDark__0EdO4',
        langDark_main: 'Lang_langDark_main__R852-',
      };
      function Je(e) {
        let { darkTheme: n } = e;
        const { i18n: r } = Ue(),
      ...
      const Ge = {
        header: 'Header_header__QnbR9',
        contscts: 'Header_contscts__Ij3EG',
        hover: 'Header_hover__zo7MB',
        theme: 'Header_theme__9lLOm',
        scrolled: 'Header_scrolled__uZQxu',
        scrolledDarck: 'Header_scrolledDarck__VeyVw',
        darkIcon: 'Header_darkIcon__NSlm8',
        heder_btns: 'Header_heder_btns__fzrwx',
        btn: 'Header_btn__iZyef',
        darkBtns: 'Header_darkBtns__UEedn',
        header_desktop: 'Header_header_desktop__eHRM0',
        contscts_desktop: 'Header_contscts_desktop__lk8Jn',
        buttonsBlock: 'Header_buttonsBlock__briUp',
        open: 'Header_open__eYAxN',
        heder_btns_tablet: 'Header_heder_btns_tablet__B2DIa',
        buttonsTablet_dark: 'Header_buttonsTablet_dark__xjqMC',
        hamburger: 'Header_hamburger__HvMtq',
        hamb_open_dark: 'Header_hamb_open_dark__6-H78',
        hamb_open: 'Header_hamb_open__X2Rsy',
        header_mobile: 'Header_header_mobile__WXtaB',
        btns_menu: 'Header_btns_menu__Nk2VP',
        header_btn_mob: 'Header_header_btn_mob__sVLgY',
        buttonsBlockMobile: 'Header_buttonsBlockMobile__TPor-',
        open_mob: 'Header_open_mob__zlt3h',
        heder_btns_mobile: 'Header_heder_btns_mobile__R1udT',
        contscts_mobile: 'Header_contscts_mobile__Js1vK',
      };
      const Xe = './static/media/github.31275de0ea5cc10633b4452f267ce18e.svg';
      const Ze = './static/media/telegram.73e5bd34a64b8348c4f5b948135844cf.svg';
      function et(e) {
      ...
      function tt(e) {
        ...
        const { t: o } = Ue(),
          a = [
            { id: 1, name: o('Home'), path: '/' },
            { id: 2, name: o('About'), path: '/about' },
            { id: 3, name: o('Tech Stack'), path: '/tech-stack' },
            { id: 4, name: o('Projects'), path: '/projects' },
            { id: 5, name: o('Contacts'), path: '/contacts' },
          ];
        return (0, Ke.jsx)('div', {
          className: ''
      ...
      const rt = 'App_app__EfVE9 App_title-color__FrIAt',
        ot = 'App_container__w2xUG',
        at = 'App_app_dark__TxDHl',
        it = './static/media/mainPhoto.2587432639a00ad5711b.png',
        lt = {
          main: 'Main_main__pJyj5',
          about: 'Main_about__wlrTL',
          mainPhoto: 'Main_mainPhoto__Z96cV',
          mainPhoto_icon: 'Main_mainPhoto_icon__jK6Gd',
          main_desctop: 'Main_main_desctop__Ueqz-',
          about_tablet: 'Main_about_tablet__ZtMgl',
          mainPhoto_tablet: 'Main_mainPhoto_tablet__esHF2',
          mainPhoto_icon_tablet: 'Main_mainPhoto_icon_tablet__82Za3',
          main_mobile: 'Main_main_mobile__RILOH',
          about_mobile: 'Main_about_mobile__yozhC',
        };
      function st(e) {
        let {
          mobileVersion: t,
      ...
      const ct = './static/media/Html.2bc4125db84296a4addd44467bb3d06a.svg';
      const ut = './static/media/Css.7bc3c189b81a23eecac4853d6d4be415.svg';
      const dt =
        './static/media/JavaScript.08b9e22a417a341fb27fbb0938f73945.svg';
      const ft = './static/media/React.a109fe4202e2e4a29909ac44de230da8.svg';
      const pt = './static/media/Redux.6c9083865af2351dec1cbda01e7a2c3e.svg';
      const ht =
        './static/media/Bootstrap.8ed01643b80d3c7e6ac98c2a6e19232c.svg';
      const mt = './static/media/Tailwind.e1550e27640e1bf045dfaffa6db404ed.svg';
      const gt = './static/media/Sass.276b242bf58b84f571b5120c4050b5ff.svg';
      const vt = './static/media/Git.ac5080213cbb38a13558413308a0a6aa.svg';
      const bt =
        './static/media/Greensock.5985a4c38a362f552ec95cf40d435a69.svg';
      const yt = './static/media/VScode.6720b02c9f7dcc765c3e446ebfd057b5.svg';
      const kt = './static/media/GitGub.6290c39c5b6b12244ac6acc3fe89860b.svg';
      const wt =
        './static/media/typescript.d8ecc4f3cfa56f8dbc346aacddedeefe.svg';
      const St = './static/media/docker.c4dbdb704ae16c606ad384b395516823.svg',
        _t = {
          stack: 'Stack_stack__Z7nX0',
          title: 'Stack_title__hcOMh',
          subtitle: 'Stack_subtitle__UBlBG',
          stack_icons: 'Stack_stack_icons__CNq1h',
          icons: 'Stack_icons__lou3A',
          darckIcon: 'Stack_darckIcon__XNmuk',
          stack_desktop: 'Stack_stack_desktop__Rvrlm',
          stack_tablet: 'Stack_stack_tablet__5WZ1j',
          subtitle_tablet: 'Stack_subtitle_tablet__R7TOW',
          stack_icons_tablet: 'Stack_stack_icons_tablet__2+F3U',
        };
      function xt(e) {
        let {
          darkTheme: t,
      ...
      const jt = './static/media/job_yan.8a54f128a3c8792260c3.png',
        Et = './static/media/dropIcon.1e0e8bd04e6f9d15c92e.png',
        Ot = './static/media/marvelIcon.e35d41575d1aa2bf194a.png',
        Ct = './static/media/pulse.2ca86940ff8efbb7dedd.png',
        Pt = './static/media/uber.75d674033a80a9390104.png',
        Nt = './static/media/dodoIcon.33c24caa5a7f76ddad49.png';
      const Tt = './static/media/live.9525a535466297b3698a7e907f18536b.svg';
      const Lt = './static/media/git.ff8209733a6b90700ab702091cb0bfdc.svg',
        Mt = {
          proj: 'Projects_proj__xqxoc',
          title: 'Projects_title__Jc-L1',
          subtitle: 'Projects_subtitle__pMI7z',
          cards: 'Projects_cards__oyMwa',
          card_img: 'Projects_card_img__jevt5',
          card: 'Projects_card__G0wNw',
          card_title: 'Projects_card_title__-W86H',
          stack: 'Projects_stack__k3D79',
          stack_dark: 'Projects_stack_dark__6G2PS',
          footer: 'Projects_footer__clH2C',
          live: 'Projects_live__zLTZC',
          code: 'Projects_code__ZzVaW',
          darkCards: 'Projects_darkCards__KquMS',
          darkIcon: 'Projects_darkIcon__I8wuM',
          proj_desctop: 'Projects_proj_desctop__cbHF3',
          cards_desctop: 'Projects_cards_desctop__qGeUZ',
          subtitle_tablet: 'Projects_subtitle_tablet__1wiCX',
          card_tablet: 'Projects_card_tablet__NhLEi',
          card_img_tablet: 'Projects_card_img_tablet__v904v',
        };
      function Rt(e) {
        let {
          item: t,
      ...
      const jn = xn,
        En = {
          footer_wrap: 'Footer_footer_wrap__X6xQa',
          footer_contacts: 'Footer_footer_contacts__Eg2iS',
          footer_link: 'Footer_footer_link__lMHId',
          line: 'Footer_line__YKjo5',
          darkLine: 'Footer_darkLine__PR+lD',
          footer_foot: 'Footer_footer_foot__oYadu',
          cretors_name: 'Footer_cretors_name__Pshy1',
          creators: 'Footer_creators__jK3fx',
          footer_contacts_dark: 'Footer_footer_contacts_dark__DEd6T',
          footer_desktop: 'Footer_footer_desktop__hlEXa',
          footer_foot_desktop: 'Footer_footer_foot_desktop__QpdX+',
          footer_wrap_mobile: 'Footer_footer_wrap_mobile__MYmUA',
          footer_contacts_mobile: 'Footer_footer_contacts_mobile__IhBuu',
        };
      function On(e) {
        let {
          darkTheme: t,
        ...
        const { t: i } = Ue(),
          ...
          s = (0, Ke.jsx)(Ke.Fragment, {
            children: (0, Ke.jsxs)('p', {
              className: ''
                .concat(En.creators, ' ')
                .concat(o ? En.creators_desctop : ''),
              children: [
                i('Designed by'),
                ' ',
                (0, Ke.jsx)('span', {
                  className: En.cretors_name,
                  children: i('Pavan MG'),
                }),
                ' ',
                i('built by'),
          ...
          children: [
            a &&
              (0, Ke.jsxs)('div', {
                ...
                children: [
                  (0, Ke.jsxs)('div', {
                    className: En.footer_wrap,
                    children: [
                      (0, Ke.jsx)(Qe, {}),
                      (0, Ke.jsxs)('div', {
                        className: ''
                          .concat(En.footer_contacts, ' ')
                          .concat(t ? En.footer_contacts_dark : ''),
                  ...
                  (0, Ke.jsx)('div', {
                    className: ''
                      .concat(En.line, ' ')
                      .concat(t ? En.darkLine : ''),
                  }),
                  (0, Ke.jsxs)('div', {
                    className: En.footer_foot,
            ...
            o &&
              (0, Ke.jsxs)('div', {
                className: ''.concat(En.footer, ' ').concat(En.footer_desktop),
                children: [
                  (0, Ke.jsxs)('div', {
                    className: En.footer_wrap,
                    children: [
                  ...
                  (0, Ke.jsxs)('div', {
                    className: ''
                      .concat(En.footer_foot, ' ')
                      .concat(En.footer_foot_desktop),
                    children: [(0, Ke.jsx)(tt, { darkTheme: t }), s],
                  }),
                ],
              }),
            ...
            n &&
              (0, Ke.jsxs)('div', {
                ...
                children: [
                  (0, Ke.jsxs)('div', {
                    className: ''
                      .concat(En.footer_wrap, ' ')
                      .concat(En.footer_wrap_mobile),
                    children: [
                      (0, Ke.jsx)(Qe, {}),
                      (0, Ke.jsxs)('div', {
                        className: ''
                          .concat(En.footer_contacts, ' ')
                          .concat(En.footer_contacts_mobile, ' ')
                          .concat(t ? En.footer_contacts_dark : ''),
                        children: [l, (0, Ke.jsx)(et, { darkTheme: t })],
                      }),
                    ],
      ...
      const Cn = './static/media/company.28501b9eb27f7debb82e98fee1780870.svg';
      const Pn = './static/media/location.6435a7b16c1e08b83eab8140e8779623.svg';
      const Nn = './static/media/period.4005a9bd4aa7af001819fd32e344158a.svg';
      const Tn = './static/media/dipl.b48775222063f2ee9f942d0daa8dbebe.svg',
        Ln = {
          aboutMe: 'AboutMe_aboutMe__UYAIX',
          aboutMe_wrap: 'AboutMe_aboutMe_wrap__SpGkf',
          worckExp: 'AboutMe_worckExp__cu90N',
          workCard: 'AboutMe_workCard__kNhcJ',
          cardHead: 'AboutMe_cardHead__HSFt0',
          cardSubheader: 'AboutMe_cardSubheader__FyEbx',
          company: 'AboutMe_company__Wedw5',
          period: 'AboutMe_period__pHNxw',
          aboutMe_desktop: 'AboutMe_aboutMe_desktop__YRVxq',
          aboutMe_wrap_desktop: 'AboutMe_aboutMe_wrap_desktop__u41xx',
          aboutMe_tablet: 'AboutMe_aboutMe_tablet__LDgBB',
          aboutMe_wrap_tablet: 'AboutMe_aboutMe_wrap_tablet__mcm33',
          aboutMe_mobile: 'AboutMe_aboutMe_mobile__17WaR',
          aboutMe_wrap_mobile: 'AboutMe_aboutMe_wrap_mobile__NaJ9G',
          worckExp_mobile: 'AboutMe_worckExp_mobile__0w7Z1',
          cardHead_mobile: 'AboutMe_cardHead_mobile__quYrK',
          company_mobile: 'AboutMe_company_mobile__y38Gf',
          cardSubheader_mobile: 'AboutMe_cardSubheader_mobile__Ku3KT',
        };
      function Mn(e) {
        let {
          mobileVersion: t,
      ...
      const Rn = {
        contact: 'Contact_contact__4k9f-',
        title: 'Contact_title__UX4p4',
        contact_desktop: 'Contact_contact_desktop__wa3Os',
        title_tablet: 'Contact_title_tablet__30Lg8',
        title_mobile: 'Contact_title_mobile__eYrly',
      };
      function zn(e) {
        let {
          darkTheme: t,
      ...
      const In = './static/media/up-arrow.8038565757bc6be5ef8bacbb1b3eb8c4.svg',
        Dn = 'Scroll_scroll__04xkH',
        Fn = 'Scroll_icon__n49XQ',
        An = () => {
...
//# sourceMappingURL=main.32cb0974.js.map
